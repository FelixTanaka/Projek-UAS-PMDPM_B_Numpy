...
model = load_model(r'C:\Users\LENOVO\Documents\Semester 5\Pembelajaran mesin dan mendalam\Bagian 6\Tugas6_B_11692\BestModel_MobileNet_Numpy.h5')
...
# Streamlit UI
st.title("Prediksi Pertumbuhan Stroberi - Numpy")  # Ganti npm terakhir
    ...
    if uploaded_files:
        ...
        for uploaded_file in uploaded_files:
            ...
            if label != "Error":
                ...
                secondary2_color = "#007BFE"  
                if label == "Tunas":
                    label_color = primary_color
                elif label == "Biji":
                    label_color = secondary2_color
                else:
